...
class User extends Base {
    ...
    const API_GETUSERINFO = '/user/getuserinfo';
     ...
     * @return boolean
     */
    public function update($uid, $name = null, $department = null, $order = null, $mobile = null, $email = null, $weixinId = null, $position = null, $gender = null, $enable = null, $avatarMediaId = null, array $extend = null) {
     ...
     * 根据code获取成员信息
     *
     * @param string $code 用户在微信端的userid.
     *
     * @return array 用户信息
     */
    public function getuserinfo($code) {
        ...
        return $this->doGet(self::API_GETUSERINFO, array(
            'code' => $code,
        ));
    }
